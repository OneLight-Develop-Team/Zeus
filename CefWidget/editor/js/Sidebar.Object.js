...
Sidebar.Object = function ( editor ) {
	...
	objectFovRow.add( new UI.Text( '视场角' ).setWidth( '90px' ) );
	...
	objectNearRow.add( new UI.Text( '最近平面' ).setWidth( '90px' ) );
	...
	objectFarRow.add( new UI.Text( '最远平面' ).setWidth( '90px' ) );
	...
	objectGroundColorRow.add( new UI.Text( '平面颜色' ).setWidth( '90px' ) );
	...
	objectPenumbraRow.add( new UI.Text( '半影' ).setWidth( '90px' ) );
	...
	objectDecayRow.add( new UI.Text( '衰减' ).setWidth( '90px' ) );
	...
	var objectCastShadow = new UI.THREE.Boolean( false, '投射' ).onChange( update );
	objectShadowRow.add( objectCastShadow );

	var objectReceiveShadow = new UI.THREE.Boolean( false, '接受' ).onChange( update );
	...
	objectVisibleRow.add( new UI.Text( '可视化' ).setWidth( '90px' ) );
